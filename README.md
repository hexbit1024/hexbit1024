...
### 🧩 Обо мне:
- 🎨 Люблю 3D-графику, VFX и программирование  
- 🎬 Создаю анимацию и видео с эффектами  
- 🔥 Разрабатываю на **JavaScript (Node.js, React, React Native)**  
- 💡 Увлекаюсь созданием игр и мультфильмов  
- 🌍 Открыт к сотрудничеству и проектам!  
...
### 🚀 Технологии:
<p align="center">
  <img src="https://skillicons.dev/icons?i=js,ts,nodejs,react,redux,html,css,tailwind,mysql,sqlite,git,github,blender,maya,aftereffects,figma" />
</p>
